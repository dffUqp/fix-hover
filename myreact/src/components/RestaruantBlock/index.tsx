...
import StoreBlock from '../CardsBlock';
import styles from './Restaurant.module.scss';
import storeItems from '../../data/resItems.json';

const RestaruantBlock = () => {
  return (
    <section>
      <div className={styles['restaurant']}>
        <div className={styles['restaurant__text']}>
          ...
          <span className={styles['restaurant__text__categories']}>Pizza</span>
        </div>

        <StoreBlock data={storeItems} />
      </div>
    </section>
  );
};

export default RestaruantBlock;
